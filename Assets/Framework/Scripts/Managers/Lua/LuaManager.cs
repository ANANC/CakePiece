...
public class LuaManager : BaseBehaviour
{
    ...
    private void InitLuaPath()
    {
        if (Application.isEditor)
        {
            ...
            {
                Debug.Log("LuaSearchPath 2 : " + Application.dataPath + "/" + FrameworkDefine.LUAPATHCONFIG_DEFAULT);
                ...
                m_LuaState.AddSearchPath(Application.dataPath + "/" + FrameworkDefine.LUAPATHCONFIG_DEFAULT + "/Data");
            }
        }
        else
        {
