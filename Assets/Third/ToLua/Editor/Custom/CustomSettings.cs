...
{
    public static string RootPath = Application.dataPath + "/Third/ToLua";
    public static string saveDir = RootPath + "/Source/Generate/";    
    public static string toluaBaseType = RootPath + "/ToLua/BaseType/";
    public static string baseLuaDir = RootPath + "/Tolua/Lua/";
    public static string injectionFilesPath = RootPath + "/ToLua/Injection/";
